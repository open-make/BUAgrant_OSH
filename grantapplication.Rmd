...
- Prof. Matthew Larkum, Institute of Biology, Humboldt-Universität zu Berlin. matthew.larkum@hu-berlin.de, +49 (0)30 450 539 152.
...
While hardware making is getting professionalised in academia, and while hardware makers communities have gotten organised during the last years, there is presently no system to assess the quality of that work, and no recognition system for researchers building open, FAIR hardware. With this practice oriented project, the Berlin university Alliance will become an orchestrating center in the development of novel standards and tools for hardware documentation and publication. 
...
While articles production is still the major source of recognition for researchers, other, non-traditional research outputs are starting to be recognized (see guideline 13 of the DFG kodex). In particular, there are new publication pathways for research data and research software, via specific platforms that use datacite to get a doi and proper metadata. The specialised platforms run rather independently of the usual journals articles presenting the research results. Citations are dealt via the scholarly communication ecosystem, but citation to the original data or software (instead of the first article using it) is recommended by a RDA group `r citep("https://doi.org/10.12688/f1000research.26932.2")`. 
...
The hardware makers communities are organising themselves, but their work is not yet recognised as being an integral part of the academic success. 
