...
We have strong connection to the TU Deflt that has been a leading institution for the implementation of open science practices, in particular in terms of open hardware. We had the possibility to observe their work and strategy (notably thanks to an outgoing fellowship) and will build on this experiences to adapt the strategy to the BUA context. QThe quite recently, they were the first university to open a position of open hardware engineer, dedicated in the development of an open hardware community at the university level. They also provided a specific curriculum (the open hardware academy), which ran for the first time in 2022. 
 
The open make project has already be a leading 


Open source research data management and archival systems such as Dataverse and InvenioRDM already exist, with the latter powering the popular Zenodo general-purpose open repository. From the perspective of a hardware publication platform these only implement the functionality of archival and DOI citation.

Manually curated directories of open source hardware projects with varying focuses and degrees of review/certification have been created of the years. Our system is not meant to replace them, instead it will be designed to assist hardware projects during development to streamline the later publishing process and also ease integration in such directories.

The HERMES project, which has published a white paper describing automated workflows for publishing FAIR research software, will be adapted for our hardware publication system.
